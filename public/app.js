...
var _root = require('./root/root.component');
...
exports.default = _vendor.Marionette.Application.extend({
  ...
  initialize: function initialize() {
    ...
    this.on('start', function () {
      _this.showView(new _root2.default());
    });
  }
});

},{"../vendor/vendor":19,"./root/root.component":11}],2:[function(require,module,exports){
'use strict';
...
var _cardTemplateJst = require('./card.template.jst.ejs');

var _cardTemplateJst2 = _interopRequireDefault(_cardTemplateJst);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _vendor.Marionette.View.extend({
  template: _cardTemplateJst2.default,
  className: 'panel panel-default'
});

},{"../../vendor/vendor":19,"./card.template.jst.ejs":3}],3:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="panel-body"> <div class="text-center text-primary">'+
((__t=( text ))==null?'':__t)+
'</div> <div class="text-center text-primary card__caption">'+
...
var SP_COORDINATES = exports.SP_COORDINATES = {
  north: -23.356604,
  south: -24.008221,
  east: -46.365084,
  west: -46.825514
...
var ACME_COORDINATES = exports.ACME_COORDINATES = {
  lat: -23.5842987,
  lng: -46.68128839999997
};

var API_KEY = exports.API_KEY = 'AIzaSyBUWrk-7hMzxkYfmv5_vUkC1Txs1h29Wjs';
...
var _formTemplateJst = require('./form.template.jst.ejs');

var _formTemplateJst2 = _interopRequireDefault(_formTemplateJst);
...
exports.default = _vendor.Marionette.View.extend({
  template: _formTemplateJst2.default,
  ...
  addressInputs: ['street_number', 'route', 'postal_code', 'sublocality_level_1'],
  initialize: function initialize() {
    _vendor.BackboneValidation.bind(this);
  },
  ...
  initAutoComplete: function initAutoComplete() {
    ...
    var coordinates = _constants.SP_COORDINATES;
    var defaultBounds = new google.maps.LatLngBounds(new google.maps.LatLng(coordinates.south, coordinates.west), new google.maps.LatLng(coordinates.north, coordinates.east));
    this.autocomplete = new google.maps.places.Autocomplete(this.ui.route[0], { types: ['geocode'], bounds: defaultBounds, componentRestrictions: { country: 'br' } });
...
},{"../../vendor/vendor":19,"../constants":4,"./form.template.jst.ejs":7}],6:[function(require,module,exports){
'use strict';
...
},{"../../vendor/vendor":19}],7:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="text-center"><h2 class="text-grey">Acme</h2></div> <div class="hidden alert alert-danger" data-ui="alert"> <button type="button" data-ui="close" class="close">&times;</button> <small>Favor preencher os campos obrigatórios</small> </div> <input type="text" data-ui="route" class="route route-input" placeholder="Endereço - ex: Av. Paulista, 210" autocomplete="off"> <form class="form"> <fieldset> <div class="form-group"> <input type="text" name="name" placeholder="Nome" class="form-control" required> </div> <div class="form-group"> <input type="email" name="email" placeholder="E-mail" class="form-control" required> </div> <div class="form-group"> <input type="text" name="phone" placeholder="Telefone" class="form-control" data-ui="phone"> </div> <div class="form-group"> <input type="text" name="route" class="form-control text-white" id="route" required autocomplete="off" tabindex="-1"> </div> <div class="form-group clearfix"> <input type="text" name="street_number" placeholder="N°" class="form-control form__number pull-left" id="street_number"> <input type="text" name="postal_code" placeholder="CEP" class="form-control form__code pull-left" id="postal_code"> </div> <div class="form-group"> <input type="text" name="sublocality_level_1" placeholder="Bairro" class="form-control" id="sublocality_level_1"> </div> <button class="btn btn-primary btn-block">FAZER PEDIDO!</button> </fieldset> </form>';
}
return __p;
};
...
var _mapTemplateJst = require('./map.template.jst.ejs');

var _mapTemplateJst2 = _interopRequireDefault(_mapTemplateJst);
...
/* globals google */
exports.default = _vendor.Marionette.View.extend({
  template: _mapTemplateJst2.default,
  ...
  initialize: function initialize() {
    var coords = _constants.ACME_COORDINATES;
  ...
  setZoom: function setZoom(number) {
  ...
  showCircle: function showCircle() {
  ...
  onChangeFormattedAddress: function onChangeFormattedAddress() {
    this.setAddressCoordinates();
  },
  getAddress: function getAddress() {
    return this.model.get('formatted_address');
  },
  getAddressCoordinates: function getAddressCoordinates() {
    return $.get('https://maps.googleapis.com/maps/api/geocode/json?&address=' + this.getAddress() + '&key=' + _constants.API_KEY);
  },
  setAddressCoordinates: function setAddressCoordinates() {
    var _this = this;
    ...
    deferred.fail(function () {
      ...
      if (response.error_message) {
        ...
        _this.model.set('location', latLng);
      }
    });
  },
  showDirections: function showDirections() {
    ...
    this.directionsService.route({
      ...
      if (status === 'OK') {
        ...
        _this2.showDuration('Tempo de entrega:', duration);
  ...
  hideDirections: function hideDirections() {
    this.directionsDisplay.setMap(null);
  },
  showDuration: function showDuration(text, duration) {
    this.showChildView('cardRegion', new _card2.default({
      model: new _vendor.Backbone.Model({ text: text, duration: duration })
    }));
  },
  isWithinTheCircle: function isWithinTheCircle() {
...
},{"../../vendor/vendor":19,"../card/card.component":2,"../constants":4,"./map.template.jst.ejs":10}],10:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div data-region="card" class="card"></div> <div data-ui="map" class="map full-height"></div>';
}
return __p;
};
...
var _rootTemplateJst = require('./root.template.jst.ejs');

var _rootTemplateJst2 = _interopRequireDefault(_rootTemplateJst);

var _form = require('../form/form.model');

var _form2 = _interopRequireDefault(_form);

var _form3 = require('../form/form.component');

var _form4 = _interopRequireDefault(_form3);

var _map = require('../map/map.component');
...
exports.default = _vendor.Marionette.View.extend({
  template: _rootTemplateJst2.default,
  ...
  initialize: function initialize() {
    this.formModel = new _form2.default();
  },
  onRender: function onRender() {
    this.showSideBar();
    this.showMap();
  ...
  showSideBar: function showSideBar() {
    this.showChildView('sideBarRegion', new _form4.default({ model: this.formModel }));
  },
  showMap: function showMap() {
    this.showChildView('mapRegion', new _map2.default({ model: this.formModel }));
  },
  onSubmitForm: function onSubmitForm(childModel) {
    this.map.set('place', childModel.get('place'));
  },
  slideForm: function slideForm() {
    this.$('.side-bar').toggleClass('slide');
  }
});

},{"../../vendor/vendor":19,"../form/form.component":5,"../form/form.model":6,"../map/map.component":9,"./root.template.jst.ejs":12}],12:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div data-region="side-bar" class="side-bar pull-left"></div> <div data-region="map" class="map-container full-height pull-left"></div> <button class="btn btn-primary btn-block visible-xs-block mobile-button" data-ui="button">VERIFICAR DISPONIBILIDADE</button>';
}
return __p;
};
...
},{"backbone":16,"underscore":18}],14:[function(require,module,exports){
...
},{"backbone":16,"backbone.radio":15,"underscore":18}],15:[function(require,module,exports){
...
},{"backbone":16,"underscore":18}],16:[function(require,module,exports){
(function (global){
//     Backbone.js 1.3.3
...
exports.Marionette = exports.BackboneValidation = exports.Backbone = exports._ = undefined;
...
_underscore2.default.extend(_backbone2.default.Model.prototype, _backboneValidation2.default.mixin);
exports._ = _underscore2.default;
exports.Backbone = _backbone2.default;
exports.BackboneValidation = _backboneValidation2.default;
exports.Marionette = _backbone4.default;

},{"backbone":16,"backbone-validation":13,"backbone.marionette":14,"underscore":18}]},{},[8]);
